...
public class Main {
    public static void main(String[] args) {
        ...
        boolean added = reservationService.addReservation("Ayberk", LocalDateTime.of(2025, 3, 15, 19, 0), 101);
        System.out.println("Were reservations added successfully? ");
        System.out.println(added);

        //Trying to add a conflicting reservation
        boolean conflict = reservationService.addReservation("Ali", LocalDateTime.of(2025, 3, 15, 19, 0), 101);
        ...
        boolean cancelled = reservationService.cancelReservation("Ayberk", LocalDateTime.of(2025, 3, 15, 19, 0), 101);
